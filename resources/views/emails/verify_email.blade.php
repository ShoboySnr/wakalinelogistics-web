...
<p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6;">
  Hi {{ $name }}, thanks for signing up! Enter the code below to verify your email and unlock your <strong style="color:#111827;">3,500 credit signup bonus</strong>.
</p>
...
<div style="background:#fefce8;border:1px solid #fde047;border-radius:10px;padding:14px 18px;margin:0 0 24px;">
  <p style="margin:0;color:#854d0e;font-size:13px;font-weight:600;">🎁 3,500 credits will be added to your account once your email is verified.</p>
</div>
