...
<div class="px-4 sm:px-6 lg:px-0">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Update rider information</p>
    </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <form method="POST" action="{{ route('admin.riders.update', $rider->id) }}" enctype="multipart/form-data" class="px-6 py-4">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" required
                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                           value="{{ old('phone', $rider->phone) }}" placeholder="+234 810 000 0000">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="age" id="age" min="18" max="100"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                           value="{{ old('age', $rider->age) }}" placeholder="25">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="vehicle_number" id="vehicle_number"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                           value="{{ old('vehicle_number', $rider->vehicle_number) }}" placeholder="ABC-123-XY">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="3"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('address', $rider->address) }}</textarea>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="guarantor1_full_name" id="guarantor1_full_name"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_full_name', $rider->guarantor1_full_name) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="guarantor1_dob" id="guarantor1_dob"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_dob', $rider->guarantor1_dob) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor1_nationality" id="guarantor1_nationality"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_nationality', $rider->guarantor1_nationality ?? 'Nigerian') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor1_occupation" id="guarantor1_occupation"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_occupation', $rider->guarantor1_occupation) }}" placeholder="e.g., Teacher, Engineer">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor1_nin" id="guarantor1_nin"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_nin', $rider->guarantor1_nin) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor1_phone" id="guarantor1_phone"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_phone', $rider->guarantor1_phone) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor1_alt_phone1" id="guarantor1_alt_phone1"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_alt_phone1', $rider->guarantor1_alt_phone1) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor1_alt_phone2" id="guarantor1_alt_phone2"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_alt_phone2', $rider->guarantor1_alt_phone2) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor1_relationship" id="guarantor1_relationship"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_relationship', $rider->guarantor1_relationship) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="guarantor1_years_known" id="guarantor1_years_known"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor1_years_known', $rider->guarantor1_years_known) }}">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="guarantor1_residential_address" id="guarantor1_residential_address" rows="2"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('guarantor1_residential_address', $rider->guarantor1_residential_address) }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="guarantor1_work_address" id="guarantor1_work_address" rows="2"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('guarantor1_work_address', $rider->guarantor1_work_address) }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="guarantor2_full_name" id="guarantor2_full_name"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_full_name', $rider->guarantor2_full_name) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="guarantor2_dob" id="guarantor2_dob"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_dob', $rider->guarantor2_dob) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor2_nationality" id="guarantor2_nationality"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_nationality', $rider->guarantor2_nationality ?? 'Nigerian') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor2_occupation" id="guarantor2_occupation"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_occupation', $rider->guarantor2_occupation) }}" placeholder="e.g., Teacher, Engineer">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor2_nin" id="guarantor2_nin"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_nin', $rider->guarantor2_nin) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor2_phone" id="guarantor2_phone"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_phone', $rider->guarantor2_phone) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor2_alt_phone1" id="guarantor2_alt_phone1"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_alt_phone1', $rider->guarantor2_alt_phone1) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="guarantor2_alt_phone2" id="guarantor2_alt_phone2"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_alt_phone2', $rider->guarantor2_alt_phone2) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guarantor2_relationship" id="guarantor2_relationship"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_relationship', $rider->guarantor2_relationship) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="guarantor2_years_known" id="guarantor2_years_known"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('guarantor2_years_known', $rider->guarantor2_years_known) }}">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="guarantor2_residential_address" id="guarantor2_residential_address" rows="2"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('guarantor2_residential_address', $rider->guarantor2_residential_address) }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="guarantor2_work_address" id="guarantor2_work_address" rows="2"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('guarantor2_work_address', $rider->guarantor2_work_address) }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="witness_full_name" id="witness_full_name"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('witness_full_name', $rider->witness_full_name) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="witness_phone" id="witness_phone"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('witness_phone', $rider->witness_phone) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="witness_date" id="witness_date"
                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                               value="{{ old('witness_date', $rider->witness_date) }}">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="witness_address" id="witness_address" rows="2"
                                  class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">{{ old('witness_address', $rider->witness_address) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('admin.riders', $rider->guarantor1_" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
