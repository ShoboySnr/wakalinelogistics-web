...
<div class="px-4 sm:px-6 lg:px-0">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Create a new client with saved pickup information for faster order creation</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.clients.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="email" name="alternate_email" id="alternate_email" value="{{ old('alternate_email') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="pickup_address" id="pickup_address" rows="2" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 @error('pickup_address') border-red-500 @enderror">{{ old('pickup_address') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="business_address" id="business_address" rows="2"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 @error('business_address') border-red-500 @enderror">{{ old('business_address') }}</textarea>
                ...
                <div>
                    ...
                    <select name="payment_terms" id="payment_terms"
                        ...
                        <option value="prepaid" {{ old('payment_terms', 'prepaid') == 'prepaid' ? 'selected' : '' }}>Prepaid</option>
                        <option value="postpaid" {{ old('payment_terms') == 'postpaid' ? 'selected' : '' }}>Postpaid</option>
                        <option value="credit_30" {{ old('payment_terms') == 'credit_30' ? 'selected' : '' }}>Net 30 Days</option>
                        <option value="credit_60" {{ old('payment_terms') == 'credit_60' ? 'selected' : '' }}>Net 60 Days</option>
                    </select>
                    @error('payment_terms')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="credit_limit" id="credit_limit" value="{{ old('credit_limit') }}"
                ...
                <div>
                    ...
                    <input type="date" name="onboarded_date" id="onboarded_date" value="{{ old('onboarded_date', date('Y-m-d')) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="2"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="special_instructions" id="special_instructions" rows="2"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 @error('special_instructions') border-red-500 @enderror">{{ old('special_instructions') }}</textarea>
